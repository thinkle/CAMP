<script lang="ts">
  import {
    evolveSchedules,
    improveSchedules,
  } from "../scheduler/hillclimbing/evolveSchedules.js";
  ...
  function doGenerate() {
    ...
    schedules = generateSchedulesFromHeuristics(
      10,
...
<div class="tester">
  <Button on:click={loadBuildData}
    >Load Build Data from Previous Builds...</Button
  >
  ...
  <hr />
  <Button on:click={autoBuild} disabled={autoBuilding}
    >Continuously Build...</Button
  >
  {#if autoBuilding}
