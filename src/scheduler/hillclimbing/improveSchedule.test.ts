...
describe("improveSchedule", () => {
  it("should improve the schedule when possible (by activity preference)", () => {
    ...
    const studentPreferences: StudentPreferences[] = [
      {
        identifier: "student1",
        activity: [{ activity: "activity2", weight: 10 }],
        peer: [],
      },
      {
        identifier: "student2",
        activity: [{ activity: "activity1", weight: 10 }],
        peer: [],
      },
    ];
    ...
    const improvedSchedule = improveSchedule(
      schedule,
      studentPreferences,
      activities
    );
  ...
  it("should improve the schedule when possible (by peer preference)", () => {
    ...
    expect(
      a1Activity,
      "Should put peers together who want to be together"
    ).toBe(a2Activity);
    expect(
      b1Activity,
      "Should put peers together who want to be together"
  ...
  it("Should honor negative weights", () => {
    ...
    expect(a1Activity, "Should keep apart peers w/ negative weights").not.toBe(
      a2Activity
    );
    expect(b1Activity, "Should keep apart peers w/ negative weights").not.toBe(
      b2Activity
    );
  });
